 ...
 */
class Version20181221222830 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE entry CHANGE url url VARCHAR(500) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE title title VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE category category VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE created created DATETIME NOT NULL, CHANGE updated updated DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE tag CHANGE name name VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE created created DATETIME NOT NULL, CHANGE updated updated DATETIME NOT NULL');
